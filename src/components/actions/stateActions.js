export const setUser =
  ({ displayName, sipUri, password, outboundProxy, autoRegister }) =>
  (dispatch) => {
    dispatch({
      type: 'SET_USER',
      payload: {
...
export const toggleRemoteAudio =
  ({ sipSession }) =>
  (dispatch) => {
    dispatch({
...
export const toggleRemoteVideo =
  ({ sipSession }) =>
  (dispatch) => {
    dispatch({
...
export const addSessionToHistory =
  ({ displayName, sipUri, direction, startTime }) =>
  (dispatch) => {
    dispatch({
